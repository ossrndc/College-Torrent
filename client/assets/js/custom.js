...
function createDownloadingTemplate(name) {
    var template = '<div class="pink">' + '' + '                        <div class="col s4">' + '                            <p>File Name</p>' + '                        </div>' + '                        <div class="col s8">' + '                            <p>{{filename}}</p>' + '                        </div>' + '                        <div class="progress">' + '                            <div class="determinate" style="width: 20%"></div>' + '                        </div>' + '' + '                    </div>';
...
},{"../transport":16,"component-inherit":13,"debug":23,"engine.io-parser":25,"parseqs":34,"ws":9,"yeast":51}],22:[function(require,module,exports){
(function (global){
